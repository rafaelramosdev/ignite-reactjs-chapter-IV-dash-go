<h1 align="center">
  <img alt="dashgo." title="dashgo." src=".github/logo.svg" width="160px"/>
</h1>
...
<p align="center">
  <img alt="dashgo." src=".github/cover.png" width="100%">
</p>
...
O projeto tem como objetivo o estudo e desenvolvimento de uma aplicação em React com NextJS para implementação de um dashboard.

dashgo. foi desenvolvido utilizando o framework NextJS utilizando o Chakra UI para montagem da interface, React Hook Form para gerenciamento dos formulários, Yup para validação de formulários e MirageJS para simular uma API.
